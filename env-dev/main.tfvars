parameters = [
  ...
  { name = "dev.user.redis_host", value = "elasticache-dev-elasticache.lzqlmk.ng.0001.use1.cache.amazonaws.com" },
  { name = "dev.user.mongo_endpoint", value = "mongodb-dev.mdevops333.online" },
  { name = "dev.cart.redis_host", value = "elasticache-dev-elasticache.lzqlmk.ng.0001.use1.cache.amazonaws.com" },
  { name = "dev.cart.catalogue_host", value = "catalogue-dev.mdevops333.online" },
  { name = "dev.cart.catalogue_port", value = "80" },
  { name = "dev.shipping.cart_endpoint", value = "cart-dev.mdevops333.online:80" },
  { name = "dev.rds.db_host", value = "rds-dev-rds.cluster-ce5xdedjezfv.us-east-1.rds.amazonaws.com" },
  ...
  { name = "dev.docdb.db_endpoint", value = "docdb-dev.cluster-ce5xdedjezfv.us-east-1.docdb.amazonaws.com" }
]
...
passwords = [
  ...
  { name = "dev.user.mongo_url", value = "mongodb://roboshop:roboshop123456@docdb-dev.cluster-ce5xdedjezfv.us-east-1.docdb.amazonaws.com:27017/users?tls=true&replicaSet=rs0&readPreference=secondaryPreferred&retryWrites=false" }
