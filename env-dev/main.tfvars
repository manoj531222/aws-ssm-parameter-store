parameters = [
  ...
  { name = "dev.docdb.db_endpoint", value = "docdb-dev.cluster-ce5xdedjezfv.global.docdb.amazonaws.com" }
]
...
passwords = [
  ...
  { name = "dev.catalogue.mongo_url", value = "mongodb://roboshop:roboshop123456@docdb-dev.cluster-ce5xdedjezfv.global.docdb.amazonaws.com:27017/catalogue?tls=true&replicaSet=rs0&readPreference=secondaryPreferred&retryWrites=false" }
]
